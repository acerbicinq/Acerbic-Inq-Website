...
The system will automatically detect and parse the format.`,
        ...
        },
        {
          ...
          type: 'boolean',
          description: 'Enable real-time transcript synchronization with audio/video playback (automatically enabled when transcript data is present)',
          initialValue: true,
          readOnly: ({document}) => !!(document?.transcript?.transcriptData || document?.transcript?.transcriptFile),
          hidden: ({document}) => !!(document?.transcript?.transcriptData || document?.transcript?.transcriptFile),
        },
        {
          name: 'formatHint',
